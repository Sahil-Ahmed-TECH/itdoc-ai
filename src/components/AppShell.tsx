...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      <aside className="hidden w-[350px] shrink-0 border-r border-sidebar-border lg:block">
  <SidebarContent
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        <header className="flex items-center justify-between border-b border-sidebar-border bg-sidebar px-4 py-3 lg:hidden">
          <button
            ...
            className="flex h-9 w-9 items-center justify-center rounded-lg text-muted-foreground transition-all duration-150 ease-out active:scale-[0.95] hover:bg-muted"
