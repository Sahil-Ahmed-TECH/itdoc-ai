      ...
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          <button
            ...
            className="inline-flex items-center justify-center rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground transition-all duration-150 ease-out hover:scale-[1.01] active:scale-[1] hover:bg-primary/90"
          >
            Try again
          </button>
...
function RootComponent() {
  ...
  const topologyStyle: CSSProperties & { "--grid-size": string } = {
    "--grid-size": "32px",
    maskImage:
