      ...
      <div className="flex flex-1 items-center justify-center px-5 py-12">
        <div className="w-full max-w-md">
          ...
          <button
            ...
            className="mt-5 w-full text-center text-xs text-muted-foreground underline-offset-4 transition-all duration-150 ease-out active:scale-[0.95] hover:underline"
          >
            {mode === "signin"
